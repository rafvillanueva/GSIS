        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="accounts">
                        <img src="img/user.png" height="32" style="position: relative;">
                        <b> &nbsp; User Accounts </b>
                    </a>
                    <a href="Registrar/registrar">
                        <img src="img/Admin.png" height="32" style="position: relative;">
                        <b> &nbsp; Record Administrator </b>
                    </a>
                    <a href="password">
                        <img src="Registrar/assets/icons/Key_96px.png" height="32" style="position: relative;">
                        <b> &nbsp; Change Password </b>
                    </a>
                   <!-- <a href="../">
