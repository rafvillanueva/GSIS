        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                            ...
                            <tbody>
                                <?php
                                    if(isset($_POST['btn-search'])){
                                        ...
                                        $students = "SELECT * FROM tbl_students WHERE s_id = '$val' OR (s_fname like '%$val%' OR s_lname like '%$val%' OR s_mname like '%$val%' OR s_gender like '%$val%' OR s_level like '%$val%') ORDER BY s_level DESC LIMIT 0,$perrow";
                                        $student_query = mysqli_query($conn, $students);
                                        while($row = mysqli_fetch_array($student_query)){
                                            ?>
                                            <tr onclick="window.location='view-student?id=<?= $row[1] ?>';" id="xhover">
                                                <!-- <td><?= $row[1] ?></td> -->
                                        ...
                                        if(isset($_GET['q'])){
                                            $g = $_GET['q'];
                                            $rs = mysqli_query($conn, "SELECT * FROM tbl_students WHERE s_level like '$g' ORDER BY s_level DESC LIMIT $p,$perrow");
                                        }else{
                                            $rs = mysqli_query($conn, "SELECT * FROM tbl_students ORDER BY s_level ASC LIMIT $p,$perrow");
                                        }
                ...
                if(isset($_POST['btn-search'])){
                    ...
                    $total = mysqli_query($conn, "SELECT * FROM tbl_students WHERE s_id = '$val' OR (s_fname like '%$val%' OR s_lname like '%$val%' OR s_mname like '%$val%' OR s_gender like '%$val%' OR s_level like '%$val%') ORDER BY ID ASC LIMIT $p,$perrow");
