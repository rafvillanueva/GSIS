...
/* Prelim | 1st Grading  */
$pqs1 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_1' AND Grade_Components = 'Quiz 1' AND Year = '$acad'");
$pqs2 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_1' AND Grade_Components = 'Quiz 2' AND Year = '$acad'");
$pqs3 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_1' AND Grade_Components = 'Quiz 3' AND Year = '$acad'");
$pqs4 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_1' AND Grade_Components = 'Performance Task' AND Year = '$acad'");
$pqs5 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_1' AND Grade_Components = 'Exam' AND Year = '$acad'");
...
/* Midterm | 2nd Grading  */
$mid1 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_2' AND Grade_Components = 'Quiz 1' AND Year = '$acad'");
$mid2 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_2' AND Grade_Components = 'Quiz 2' AND Year = '$acad'");
$mid3 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_2' AND Grade_Components = 'Quiz 3' AND Year = '$acad'");
$mid4 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_2' AND Grade_Components = 'Performance Task' AND Year = '$acad'");
$mid5 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_2' AND Grade_Components = 'Exam' AND Year = '$acad'");
...
$semi1 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_3' AND Grade_Components = 'Quiz 1' AND Year = '$acad'");
$semi2 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_3' AND Grade_Components = 'Quiz 2' AND Year = '$acad'");
$semi3 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_3' AND Grade_Components = 'Quiz 3' AND Year = '$acad'");
$semi4 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_3' AND Grade_Components = 'Performance Task' AND Year = '$acad'");
$semi5 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_3' AND Grade_Components = 'Exam' AND Year = '$acad'");
...
/* Finals | 4th Grading */
$finals1 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_4' AND Grade_Components = 'Quiz 1' AND Year = '$acad'");
$finals2 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_4' AND Grade_Components = 'Quiz 2' AND Year = '$acad'");
$finals3 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_4' AND Grade_Components = 'Quiz 3' AND Year = '$acad'");
$finals4 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_4' AND Grade_Components = 'Performance Task' AND Year = '$acad'");
$finals5 = mysqli_query($conn, "SELECT sum(Score) as e, sum(Total_score) as d FROM tbl_scores WHERE  Stud_Id = '$id' AND SubjectCode = '$sub_id' AND Period = '$periodz_4' AND Grade_Components = 'Exam' AND Year = '$acad'");
