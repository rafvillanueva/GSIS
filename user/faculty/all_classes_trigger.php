                    ...
                    if($period != "Not Available"){
                        ...
                        while( $rowx = mysqli_fetch_array($query)){
                            ...
                            <tr>
                                ...
                                <input class="form-control" disabled value="<?= $row_score['Score'] . '/' . $row_score['Total_score'] ?>"  style="text-align: center;" value="0"  id="score<?= $id ?>" onblur="" >
                                ...
                                <td style="color: green;"><center>-</div></center></td>
                                <td id="ee_edit<?= $id ?>">
                                    <a href="javascript:void(0);" style="color: #333;"  onclick="">
                                         -
                                    </a>
                                </td>
                                ...
                                ?>
                                <td style=" padding-left: 1px; text-align:">
                                    <input class="form-control" disabled style="text-align: center;" value="0"  id="score<?= $id ?>" onblur="" >
                                ...
                                <td style="color: red;"><center><div id="#">-</div></center></td>
                                ...
                                function update_score_'.$id.'(){
                                    ...
                                    if(Number(total) < Number(score)){
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "save.php",
                                            data: {"ufaci_d": fac_id, "stud_id": std_id, "Acad": Acad, "Semester": sem, "Quiz": Quiz, "Period": Period, "sub_id": sub_id, "Score": score, "Total_score": total, "Grade": grade_total},
                                           success: function(html){
                                                $("#dsp").html(html);
                                                document.getElementById("grade'.$id.'").style.color = "black";
