        ...
        <table id="mytable" class="table table-striped table-responsive">
            <thead>
                <tr>
                    <th>Students</th>
                    <th>Courses</th>
                    <th style="width: 90px;"><center><small>Unexcused <br> Absences</small></center></th>
                    <th></th>
                    <th style="width: 90px; padding-left: 1px;">
                        <center>
                        <i style="font-size: 11px; text-align: center;">Perfect Score</i><input class="form-control" id="perfect" style="text-align: center;">
                        </center>
                    </th>
                    ...
                    if($period != "Not Available"){
                        ...
                        while( $rowx = mysqli_fetch_array($query)){
                            ...
                            <tr>
                                ...
                                <td><?= $rowz['Course'] ?></td>
                                <?php
                                    /*$score = mysqli_query($conn, "SELECT * FROM tbl_scores WHERE Fac_Id = '$fac_id' AND Stud_id = '$id' AND SubjectCode = '$sub_id' AND Year = '$acad' AND Grade_Components = '$quiz' AND Period = '$period'");

                                    $absences = mysqli_query($conn, "SELECT * FROM tbl_scores WHERE Fac_Id = '$fac_id' AND Stud_id = '$id' AND SubjectCode = '$sub_id' AND Year = '$acad' AND Grade_Components = 'Unexcused absences incurred' AND Period = '$period'");*/

                                    /*$row_score = mysqli_fetch_array($score);
                                    $row_absences = mysqli_fetch_array($absences);*/

                                    if(!empty($row_score['Stud_id'])){
                                        ?>
                                <td style=" width: 90px !important">
                                    <input class="form-control" value="<?= $row_absences['Score'] ?>"  style="text-align: center;;" value="0"  id="abc<?= $id ?>" onblur="<?= 'zw'.$id ?>()" >
                                </td>
                                <td></td>
                                ...
                                <input type="hidden" id="edit1_status<?= $id ?>">
                                </td>
                                ...
                                ?>
                                <td>
                                    <input class="form-control" style="text-align: center;"  value="" id="abc<?= $id ?>"  <?= $css_absent ?> >
                                ...
                                <td></td>
                                <td>
                                     <input class="form-control" style="text-align: center;" value=""  id="score<?= $id ?>" onblur="<?= 'w'.$id ?>()">
                                </td> 
                                <td><center><div id="grade<?= $id ?>"></div></center></td>
                            ...
                            echo '<script type="text/javascript">
                                function w'.$id.'(){
                                    ...
                                    var status = document.getElementById("edit1_status'.$id.'").value;
                                    if(status != "Ready"){
                                    ...
                                    var total = document.getElementById("perfect").value;
                                    var sectionx = document.getElementById("sectionx").value;
                                    var score = document.getElementById("score'.$id.'").value;
                                    var absent = document.getElementById("abc'.$id.'").value;
                                    var grade_total = (score / total) * 50 + 50;
                                    ...
                                    if(Number(total) < Number(score)){
                                        ...
                                        if(absent == ""){
                                            document.getElementById("grade'.$id.'").innerHTML = "<small>[Unexcused Absences] <br> You must enter atleast 0</small>";
                                            document.getElementById("grade'.$id.'").style.color = "red";
                                        }else{
                                            $.ajax({
                                                type: "POST",
                                                url: "save.php",
                                                data: {"faci_d": fac_id, "stud_id": std_id, "Acad": Acad, "Semester": sem, "Quiz": Quiz, "Period": Period, "sub_id": sub_id, "Score": score, "Total_score": total, "Grade": grade_total, "sectionx": sectionx, "absent": absent},
                                ...
                                function save_score_'.$id.'(){
                                    ...
                                    if(Number(total) < Number(score)){
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "save.php",
                                            data: {"faci_d": fac_id, "stud_id": std_id, "Acad": Acad, "Semester": sem, "Quiz": Quiz, "Period": Period, "sub_id": sub_id, "Score": score, "Total_score": total, "Grade": grade_total, "sectionx": sectionx},
                                           success: function(html){
                                                $("#dsp").html(html);
                                                document.getElementById("grade'.$id.'").style.color = "black";
                                                document.getElementById("aftersave'.$id.'").style.display = "block";
                                        ...
                                        if(absent == ""){
                                            ...
                                            document.getElementById("grade'.$id.'").style.color = "red";
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "save.php",
                                                    data: {"ufaci_d": fac_id, "stud_id": std_id, "Acad": Acad, "Semester": sem, "Quiz": Quiz, "Period": Period, "sub_id": sub_id, "Score": score, "Total_score": total, "Grade": grade_total, "absent": absent},
                                                   success: function(html){
                                                        $("#dsp").html(html);
                                                        document.getElementById("grade'.$id.'").style.color = "black";
                                                        document.getElementById("grade'.$id.'").innerHTML = grade_total.toFixed(2);
                                                        ...
                                                        document.getElementById("edit1_status'.$id.'").value = "";
                                                        document.getElementById("edit_gradex'.$id.'").value = grade_total;
                                                    },
                                                }); 
                                            }
                                ...
                                function edit_score_'.$id.'(){
                                    ...
                                    document.getElementById("edit1_status'.$id.'").value = "Ready";
