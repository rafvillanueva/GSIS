    ...
    ?>
        <table id="mytable" class="table table-striped table-responsive">
            <thead>
                <tr>
                    <th>Student</th>
                    <th style=" width: 140px; padding-left: 1px;"><i style="font-size: 11px; text-align: center;">Unexcused Absences</i><input class="form-control" value="365" id="perfect" style="text-align: center; display: none;"></th>
                    <th></th>
                    <th><center style="display: none;">Grade</center></th>
                    ...
                    if($period != "Not Available"){
                        ...
                        while( $rowx = mysqli_fetch_array($query)){
                            ...
                            <tr>
                                ...
                                <input class="form-control" disabled value="<?= $row_score['Score'] ?>"  style="text-align: center;" value="0"  id="score<?= $id ?>" onblur="<?= 'w'.$id ?>()" >
                                ...
                                <td></td>
                                <td><center><div id="grade<?= $id ?>" style="display: none;"><?= number_format((float)$row_score['Grade'], 2, '.', ',') ?></div></center></td>
                                ...
                                <td></td>
                                <td><center><div id="grade<?= $id ?>" style="display: none;">0</div></center></td>
