        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                <li class="sidebar-search">
                    ...
                    <a href="javascript:void(0)" onclick="pirnt()" target="_blank">
                        <img src="controls/icons/Print_96px.png" height="32" style="position: relative;">
                        <b> Print</b>
                    </a>
            ...
            <div class="panel-heading">
                <div class="row">  
                    <div class="col-lg-9" style="display: block;">
                        <b style="font-size: 32px; padding-top: 50px;">Subject Code : <u><?= $row_d['subjectCode'] ?></u></b>
                    </div>
...
<script type="text/javascript">
    ...
    function pirnt(){
        var period = document.getElementById("period").value;
        window.location.href = "print.php?subject=<?= $_GET['subject'] ?>&sec=<?= $_GET['sec'] ?>&ss=<?= $_GET['ss'] ?>&op=" + period;
    }
</script>
